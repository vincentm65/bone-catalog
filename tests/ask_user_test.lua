...
assert(calls[1].spec.allow_back == false)
assert(calls[1].spec.allow_forward == true)
assert(calls[2].spec.allow_back == true)
assert(calls[2].spec.allow_forward == true)
assert(calls[3].spec.allow_back == true)
assert(calls[3].spec.allow_forward == false)
